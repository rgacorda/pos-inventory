    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-6xl mx-auto">
          ...
          {!products ? (
            <div className="text-center text-gray-600 py-8 text-lg">⏳ Loading products...</div>
          ) : products.length === 0 ? (
            <div className="text-center text-gray-600 py-8">
              <p className="mb-4 text-lg">📦 No products available</p>
              <p className="text-sm text-gray-500">Products will be synced from the backend when online</p>
            </div>
          ) : (
                ...
                <tbody className="divide-y">
                  {products.map((product) => (
                    <tr key={product.id} className="hover:bg-blue-50 transition-colors">
                      <td className="px-4 py-3 text-sm font-mono text-gray-700 font-semibold">{product.sku}</td>
